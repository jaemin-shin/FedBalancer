...
'num_epochs 5',
'output_path ../models/configs/femnist/',
'global_final_time 300000']
...
for seed in range(0,3,1):
    for exp in baseline_lines:
        new_config_file = open('../models/configs/femnist/femnist_'+exp[0][0]+'_seed'+str(seed)+'.cfg', 'w')
        ...
        os.system('CUDA_VISIBLE_DEVICES='+str(gpu_id[process_count])+' python ../models/main.py --config=../models/configs/femnist/femnist_'+exp[0][0]+'_seed'+str(seed)+'.cfg &')
        process_count += 1